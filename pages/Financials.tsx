                    ...
                    <>
                        ...
                        <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-lg border border-slate-100 dark:border-slate-700 overflow-hidden">
                            ...
                            <div>
                                {activeTab === 'requests' && (
                                    <div>
                                        <div className="p-4 bg-slate-50 dark:bg-slate-900/50 border-b dark:border-slate-700 flex overflow-x-auto flex-nowrap gap-2 items-center print:hidden [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
                                            <span className="text-xs font-black text-slate-500 uppercase tracking-widest ms-2 whitespace-nowrap flex-shrink-0">تصفية حسب الدفع:</span>
                                            <button onClick={() => setPaymentStatusFilter('all')} className={`whitespace-nowrap flex-shrink-0 px-3 py-1.5 text-[10px] font-bold rounded-lg transition-all ${paymentStatusFilter === 'all' ? 'bg-blue-600 text-white shadow-md' : 'bg-white dark:bg-slate-800 border dark:border-slate-700 text-slate-600'}`}>الكل</button>
                                            <button onClick={() => setPaymentStatusFilter(PaymentType.Cash)} className={`whitespace-nowrap flex-shrink-0 px-3 py-1.5 text-[10px] font-bold rounded-lg transition-all ${paymentStatusFilter === PaymentType.Cash ? 'bg-emerald-600 text-white shadow-md' : 'bg-white dark:bg-slate-800 border dark:border-slate-700 text-slate-600'}`}>نقدي</button>
                                            <button onClick={() => setPaymentStatusFilter(PaymentType.Card)} className={`whitespace-nowrap flex-shrink-0 px-3 py-1.5 text-[10px] font-bold rounded-lg transition-all ${paymentStatusFilter === PaymentType.Card ? 'bg-blue-600 text-white shadow-md' : 'bg-white dark:bg-slate-800 border dark:border-slate-700 text-slate-600'}`}>بطاقة</button>
                                            <button onClick={() => setPaymentStatusFilter(PaymentType.Transfer)} className={`whitespace-nowrap flex-shrink-0 px-3 py-1.5 text-[10px] font-bold rounded-lg transition-all ${paymentStatusFilter === PaymentType.Transfer ? 'bg-amber-600 text-white shadow-md' : 'bg-white dark:bg-slate-800 border dark:border-slate-700 text-slate-600'}`}>تحويل</button>
                                            <button onClick={() => setPaymentStatusFilter('unpaid')} className={`whitespace-nowrap flex-shrink-0 px-3 py-1.5 text-[10px] font-bold rounded-lg transition-all ${paymentStatusFilter === 'unpaid' ? 'bg-rose-600 text-white shadow-md' : 'bg-white dark:bg-slate-800 border dark:border-slate-700 text-slate-600'}`}>آجل</button>
                                        </div>
